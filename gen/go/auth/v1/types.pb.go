...
const file_auth_v1_types_proto_rawDesc = "" +
	...
	"lastUsedAt\x129\n" +
	"\n" +
	"expires_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\texpiresAtB3Z1github.com/vantutran2k1/rwe/gen/go/auth/v1;authv1b\x06proto3"
...
var file_auth_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
var file_auth_v1_types_proto_depIdxs = []int32{
	...
	9, // 1: auth.v1.ApiKeyMetadata.created_at:type_name -> google.protobuf.Timestamp
	9, // 2: auth.v1.ApiKeyMetadata.last_used_at:type_name -> google.protobuf.Timestamp
	9, // 3: auth.v1.ApiKeyMetadata.expires_at:type_name -> google.protobuf.Timestamp
